...
{
    public partial class ChangePickupAddress : Form
    {
        ...
        {
            CustomerViewBookingOrder.addrID = dgv_addrBook.CurrentRow.Cells[10].Value.ToString();
            CustomerViewBookingOrder.txtContectName.Text = dgv_addrBook.CurrentRow.Cells[0].Value.ToString();
            CustomerViewBookingOrder.txtCompanyName.Text = dgv_addrBook.CurrentRow.Cells[1].Value.ToString();
            CustomerViewBookingOrder.txtAddrLn1.Text = dgv_addrBook.CurrentRow.Cells[2].Value.ToString();
            CustomerViewBookingOrder.txtAddrLn2.Text = dgv_addrBook.CurrentRow.Cells[3].Value.ToString();
            CustomerViewBookingOrder.txtAddrLn3.Text = dgv_addrBook.CurrentRow.Cells[4].Value.ToString();
            CustomerViewBookingOrder.txtRegion.Text = dgv_addrBook.CurrentRow.Cells[5].Value.ToString();
            CustomerViewBookingOrder.txtPostcode.Text = dgv_addrBook.CurrentRow.Cells[6].Value.ToString();
            CustomerViewBookingOrder.txtPhoneNo.Text = dgv_addrBook.CurrentRow.Cells[7].Value.ToString();
            CustomerViewBookingOrder.txtFaxNo.Text = dgv_addrBook.CurrentRow.Cells[8].Value.ToString();
            CustomerViewBookingOrder.txtTelexNo.Text = dgv_addrBook.CurrentRow.Cells[9].Value.ToString();
            this.Close();
        }
