...
namespace EDEapp
{
    public partial class AddressBook_Pickup : Form
    {
        private string randomCode;
        static string log_user;
        addressbook adb1 = new addressbook();

        public AddressBook_Pickup()
        {
            InitializeComponent();
        ...
        {
            BookingOrder_01.addrID = dgv_addrBook.CurrentRow.Cells[10].Value.ToString();
            BookingOrder_01.txtContectName.Text = dgv_addrBook.CurrentRow.Cells[0].Value.ToString();
            BookingOrder_01.txtCompanyName.Text = dgv_addrBook.CurrentRow.Cells[1].Value.ToString();
            BookingOrder_01.txtAddrLn1.Text = dgv_addrBook.CurrentRow.Cells[2].Value.ToString();
            BookingOrder_01.txtAddrLn2.Text = dgv_addrBook.CurrentRow.Cells[3].Value.ToString();
            BookingOrder_01.txtAddrLn3.Text = dgv_addrBook.CurrentRow.Cells[4].Value.ToString();
            BookingOrder_01.txtRegion.Text = dgv_addrBook.CurrentRow.Cells[5].Value.ToString();
            BookingOrder_01.txtPostcode.Text = dgv_addrBook.CurrentRow.Cells[6].Value.ToString();
            BookingOrder_01.txtPhoneNo.Text = dgv_addrBook.CurrentRow.Cells[7].Value.ToString();
            BookingOrder_01.txtFaxNo.Text = dgv_addrBook.CurrentRow.Cells[8].Value.ToString();
            BookingOrder_01.txtTelexNo.Text = dgv_addrBook.CurrentRow.Cells[9].Value.ToString();
            this.Close();
        }
