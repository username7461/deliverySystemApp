...
namespace EDEapp
{
    public partial class AddressBook_Package : Form
    {
        ...
        {
            BookingOrder_03.addrID = dgv_addrBook.CurrentRow.Cells[10].Value.ToString();
            BookingOrder_03.txtContectName.Text = dgv_addrBook.CurrentRow.Cells[0].Value.ToString();
            BookingOrder_03.txtCompanyName.Text = dgv_addrBook.CurrentRow.Cells[1].Value.ToString();
            BookingOrder_03.txtAddrLn1.Text = dgv_addrBook.CurrentRow.Cells[2].Value.ToString();
            BookingOrder_03.txtAddrLn2.Text = dgv_addrBook.CurrentRow.Cells[3].Value.ToString();
            BookingOrder_03.txtAddrLn3.Text = dgv_addrBook.CurrentRow.Cells[4].Value.ToString();
            BookingOrder_03.txtRegion.Text = dgv_addrBook.CurrentRow.Cells[5].Value.ToString();
            BookingOrder_03.txtPostcode.Text = dgv_addrBook.CurrentRow.Cells[6].Value.ToString();
            BookingOrder_03.txtPhoneNo.Text = dgv_addrBook.CurrentRow.Cells[7].Value.ToString();
            BookingOrder_03.txtFaxNo.Text = dgv_addrBook.CurrentRow.Cells[8].Value.ToString();
            BookingOrder_03.txtTelexNo.Text = dgv_addrBook.CurrentRow.Cells[9].Value.ToString();
            this.Close();
        }
