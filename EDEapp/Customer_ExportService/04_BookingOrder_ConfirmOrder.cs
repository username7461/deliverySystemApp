...
namespace EDEapp
{
    public partial class BookingOrder_04 : Form
    {
        ...
        public BookingOrder_04()
        {
            InitializeComponent();
            log_user = Login.log_user;
            pickupAddrID = BookingOrder_01.addrID;
            pickupDate = BookingOrder_01.pickupDate;
            pickupTime = BookingOrder_01.pickupTime;
        ...
        private void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                using (edeaccountEntities database = new edeaccountEntities())
                {
                    ...
                    MessageBox.Show("Create booking order successfully.");
