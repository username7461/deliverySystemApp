...
namespace EDEapp {
    ...
    public partial class edeaccountDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/edeaccountDataSet5.xsd";
        ...
        public partial class addressbookDataTable : global::System.Data.TypedTableBase<addressbookRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public addressbookRow AddaddressbookRow(string contectName, string companyName, string addressLn1, string addressLn2, string addressLn3, string postcode, string phoneNo, string faxNo, string accountID) {
        ...
        public partial class addressbookRow : global::System.Data.DataRow {
            ...
            public string accountID {
                get {
                    return ((string)(this[this.tableaddressbook.accountIDColumn]));
                }
                set {
                    this[this.tableaddressbook.accountIDColumn] = value;
                }
            }
        }
...
namespace EDEapp.edeaccountDataSetTableAdapters {
    ...
    public partial class addressbookTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `addressbook` WHERE ((`addressId` = @p1) AND (`contectName` = @p2) AND (`companyName` = @p3) AND (`addressLn1` = @p4) AND (`addressLn2` = @p5) AND (`addressLn3` = @p6) AND (`postcode` = @p7) AND (`phoneNo` = @p8) AND (`faxNo` = @p9) AND (`accountID` = @p10))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `addressbook` (`contectName`, `companyName`, `addressLn1`, `addressLn" +
                "2`, `addressLn3`, `postcode`, `phoneNo`, `faxNo`, `accountID`) VALUES (@p1, @p2," +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `addressbook` SET `contectName` = @p1, `companyName` = @p2, `addressLn1` = @p3, `addressLn2` = @p4, `addressLn3` = @p5, `postcode` = @p6, `phoneNo` = @p7, `faxNo` = @p8, `accountID` = @p9 WHERE ((`addressId` = @p10) AND (`contectName` = @p11) AND (`companyName` = @p12) AND (`addressLn1` = @p13) AND (`addressLn2` = @p14) AND (`addressLn3` = @p15) AND (`postcode` = @p16) AND (`phoneNo` = @p17) AND (`faxNo` = @p18) AND (`accountID` = @p19))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `addressId`, `contectName`, `companyName`, `addressLn1`, `addressLn2`, `ad" +
                "dressLn3`, `postcode`, `phoneNo`, `faxNo`, `accountID` FROM `addressbook`";
