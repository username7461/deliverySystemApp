...
namespace EDEapp
{
    public partial class ContactEmailShaTin : Form
    {
        ...
        public ContactEmailShaTin()
        {
            InitializeComponent();
        }

        private void ContactEmailShaTin_Load(object sender, EventArgs e)
        {
            getIP();
        }
        ...
        private void btn_send_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                using (edeaccountEntities content = new edeaccountEntities())
                {
                    ...
                    to = "yuk226817@gmail.com";
                    from = (txt_email.Text).ToString();
                    pass = "lsmkvdawdilgegoa";//"pkuwndeixqypshxw";
