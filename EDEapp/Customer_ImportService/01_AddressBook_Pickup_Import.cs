...
namespace EDEapp
{
    public partial class AddressBook_Pickup_Import : Form
    {
        private string randomCode;
        static string log_user;
        addressbook adb1 = new addressbook();

        public AddressBook_Pickup_Import()
        {
            InitializeComponent();
            ...
            dgv_addrBook.AllowUserToAddRows = false;
            dgv_addrBook.ReadOnly = true;
            dgv_addrBook.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            dgv_addrBook.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            dgv_addrBook.AutoGenerateColumns = false;

            refreshGridView();
        }

        private void AddressBook_Pickup_Load(object sender, EventArgs e)
        {
        ...
        {
            BookingImportOrder_01.addrID = dgv_addrBook.CurrentRow.Cells[10].Value.ToString();
            BookingImportOrder_01.txtContectName.Text = dgv_addrBook.CurrentRow.Cells[0].Value.ToString();
            BookingImportOrder_01.txtCompanyName.Text = dgv_addrBook.CurrentRow.Cells[1].Value.ToString();
            BookingImportOrder_01.txtAddrLn1.Text = dgv_addrBook.CurrentRow.Cells[2].Value.ToString();
            BookingImportOrder_01.txtAddrLn2.Text = dgv_addrBook.CurrentRow.Cells[3].Value.ToString();
            BookingImportOrder_01.txtAddrLn3.Text = dgv_addrBook.CurrentRow.Cells[4].Value.ToString();
            BookingImportOrder_01.txtRegion.Text = dgv_addrBook.CurrentRow.Cells[5].Value.ToString();
            BookingImportOrder_01.txtPostcode.Text = dgv_addrBook.CurrentRow.Cells[6].Value.ToString();
            BookingImportOrder_01.txtPhoneNo.Text = dgv_addrBook.CurrentRow.Cells[7].Value.ToString();
            BookingImportOrder_01.txtFaxNo.Text = dgv_addrBook.CurrentRow.Cells[8].Value.ToString();
            BookingImportOrder_01.txtTelexNo.Text = dgv_addrBook.CurrentRow.Cells[9].Value.ToString();
            this.Close();
        }
        ...
        private void dgv_addrBook_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txt_addr2.Text = dgv_addrBook.CurrentRow.Cells[3].Value.ToString();
