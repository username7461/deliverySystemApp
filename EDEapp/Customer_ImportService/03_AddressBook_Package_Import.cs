...
namespace EDEapp
{
    public partial class AddressBook_Package_Import : Form
    {
        private string randomCode;
        static string log_user;
        addressbook adb1 = new addressbook();

        public AddressBook_Package_Import()
        {
            InitializeComponent();
        ...
        {
            BookingImportOrder_03.addrID = dgv_addrBook.CurrentRow.Cells[10].Value.ToString();
            BookingImportOrder_03.txtContectName.Text = dgv_addrBook.CurrentRow.Cells[0].Value.ToString();
            BookingImportOrder_03.txtCompanyName.Text = dgv_addrBook.CurrentRow.Cells[1].Value.ToString();
            BookingImportOrder_03.txtAddrLn1.Text = dgv_addrBook.CurrentRow.Cells[2].Value.ToString();
            BookingImportOrder_03.txtAddrLn2.Text = dgv_addrBook.CurrentRow.Cells[3].Value.ToString();
            BookingImportOrder_03.txtAddrLn3.Text = dgv_addrBook.CurrentRow.Cells[4].Value.ToString();
            BookingImportOrder_03.txtRegion.Text = dgv_addrBook.CurrentRow.Cells[5].Value.ToString();
            BookingImportOrder_03.txtPostcode.Text = dgv_addrBook.CurrentRow.Cells[6].Value.ToString();
            BookingImportOrder_03.txtPhoneNo.Text = dgv_addrBook.CurrentRow.Cells[7].Value.ToString();
            BookingImportOrder_03.txtFaxNo.Text = dgv_addrBook.CurrentRow.Cells[8].Value.ToString();
            BookingImportOrder_03.txtTelexNo.Text = dgv_addrBook.CurrentRow.Cells[9].Value.ToString();
            this.Close();
        }
