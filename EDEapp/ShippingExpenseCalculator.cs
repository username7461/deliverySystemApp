...
namespace EDEapp
{
    public partial class ShippingExpenseCalculator : Form
    {
        
        public ShippingExpenseCalculator()
        {
        ...
        private void btn_calculate_Click(object sender, EventArgs e)
        {
            ...
            if (txt_length.Text != "" && txt_width.Text != "" && txt_weight.Text != "")
            {
                double weight = Convert.ToDouble(txt_weight.Text);
                double width = double.Parse(txt_width.Text);
                double length = Convert.ToDouble(txt_length.Text);
